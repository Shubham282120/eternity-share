    ...
    return (
        <>
            ...
            <header class="page-header" data-background="assets/images/page-header01.jpg">
                <div class="container">
                    <h1>Baby Shower</h1>
                    <p>Celebrating new beginnings with joy.3</p>
                </div>
                {/*{/* end container */}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="room-info-box">
                                <h6>About Event</h6>
                                <p>Celebrate the upcoming arrival of your little bundle of joy with a beautifully planned Baby Shower at Eternity Banquet. Our creative décor themes, pastel styling, balloon artistry, and personalized setups create a warm and memorable atmosphere for family and friends.</p>
                                <p>We design everything from welcome boards to customized dessert tables and fun game zones, ensuring a delightful celebration filled with love, laughter, and precious memories.</p>
                            </div>
                            {/* end room-info-box */}
                        </div>
                        {/* end col-12 */}
                            ...
                            <div class="content-tab">
                                ...
                                <div id="tab01" class="tab-item active-item">
                                    <ul>
                                        ...
                                        <li><figure><img src="assets/images/icon12.png" alt="Image" /></figure><b>Customized Baby Shower Themes</b></li>
                                        ...
                                        <li><figure><img src="assets/images/icon09.png" alt="Image" /></figure><b>Balloon & Floral Decorations</b></li>
                                ...
                                <div id="tab02" class="tab-item">
                                   <p>Our baby shower setups include elegant pastel décor, backdrop designs, creative props, and cozy seating arrangements. We ensure a joyful ambiance where guests can enjoy interactive games, delicious food, and a heartwarming celebration.</p>
                                </div>
                                {/* end tab-item */}
