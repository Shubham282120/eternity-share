    ...
    return (
        <>
            ...
            <header class="page-header" data-background="assets/images/page-header01.jpg">
                <div class="container">
                    <h1>Surprise Decoration</h1>
                    <p>Moments that truly surprise and delight.</p>
                </div>
                {/*{/* end container */}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="room-info-box">
                                <h6>About Event</h6>
                                <p>Create magical and emotional moments with our Surprise Decoration services. Whether it’s an anniversary surprise, proposal setup, romantic dinner décor, or special celebration, we craft intimate and stunning arrangements that leave lasting impressions.</p>
                                <p>From candlelight setups to floral pathways and personalized message backdrops, every detail is thoughtfully designed to make your surprise truly special.</p>
                            </div>
                            {/* end room-info-box */}
                        </div>
                        {/* end col-12 */}
                            ...
                            <div class="content-tab">
                                ...
                                <div id="tab01" class="tab-item active-item">
                                    <ul>
                                        ...
                                        <li><figure><img src="assets/images/icon010.png" alt="Image" /></figure><b>Romantic Theme Setup</b></li>
                                        ...
                                        <li><figure><img src="assets/images/icon09.png" alt="Image" /></figure><b>Candlelight Decoration</b></li>
                                        <li><figure><img src="assets/images/icon09.png" alt="Image" /></figure><b>Balloon & Floral Styling</b></li>
                                        <li><figure><img src="assets/images/icon03.png" alt="Image" /></figure><b>Private Dining Arrangement </b></li>
                                ...
                                <div id="tab02" class="tab-item">
                                    <p>Our surprise décor services focus on elegance, intimacy, and emotional impact. We carefully plan lighting, color tones, and decorative elements to create a breathtaking atmosphere that perfectly captures your special moment.</p>
                                </div>
                                {/* end tab-item */}
