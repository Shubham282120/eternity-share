        ...
        <>
            ...
            <header class="page-header" data-background="assets/images/page-header01.jpg">
                <div class="container">
                    ...
                    <p>Professional events with flawless execution.</p>
                </div>
                {/*{/* end container */}
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="room-info-box">
                                <h6>About Event</h6>
                                <p>Eternity Banquet provides premium corporate event solutions tailored to your business needs. Whether it’s a conference, seminar, product launch, annual meeting, or award ceremony, we deliver a professional and polished setup that reflects your brand identity.</p>
                                <p>We combine modern technology, structured seating arrangements, and elegant décor to create a productive and impressive environment for clients and employees.</p>
                            </div>
                            {/* end room-info-box */}
                        </div>
                        {/* end col-12 */}
                            ...
                            <div class="content-tab">
                                ...
                                <div id="tab01" class="tab-item active-item">
                                    <ul>
                                        ...
                                        <li><figure><img src="assets/images/icon12.png" alt="Image" /></figure><b>Conference Hall Setup</b></li>
                                        ...
                                        <li><figure><img src="assets/images/icon13.png" alt="Image" /></figure><b>Projector & Audio System</b></li>
                                        <li><figure><img src="assets/images/icon03.png" alt="Image" /></figure><b>Catering Services</b></li>
                                ...
                                <div id="tab02" class="tab-item">
                                    <p>Our corporate setups include structured seating, stage platforms, LED screens, and high-quality sound systems. We ensure smooth event execution, punctual coordination, and a professional atmosphere suitable for business excellence.</p>
                                </div>
                                {/* end tab-item */}
